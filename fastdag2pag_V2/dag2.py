...
from fastdag2pag_V2.Utils.pmg import PMG 
from fastdag2pag_V2.Utils.sepset import SeparationSet
import pandas as pd
import numpy as np
from fastdag2pag_V2.Utils.Graph_utils import Mark, Node
...
class dag2:
    ...
    def __init__(self, data: pd.DataFrame, **kwargs):
        ...
        self.selection_bias_rules = kwargs.get("selection_bias_rules", True)  # Whether to consider selection bias in orient rules, default is False
